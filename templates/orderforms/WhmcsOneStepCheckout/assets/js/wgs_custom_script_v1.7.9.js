...
jQuery(document).ready(function(){
	...
	jQuery(document).on("change","input[name='productRadio']",function(){
		if(jQuery(".check_box.Plan").hasClass("active")){
			jQuery(".check_box.Plan").removeClass("active");
		}
		...
		if (jQuery("#wgsCartCount").val() > 0) {
			wgsRemoveProductFromCartAll();
			setTimeout(function(){ wgsAddProductGetProductRelatedInfo(that,pid); }, 2000);	
	   } else {
		...
		jQuery.ajax({
			...
			success:function (data) {
				...
				productString += `
								...
								<div class="col-sm-12 col-md-4 intel_box">
									<div class="check_box Plan">
										<input type="radio" id="prod30" value="30" name="productRadio">
										<label for="prod30">
											<span class="price">
												<div class="card text-center">
												  <div class="card-body shadow-sm">
													  <h3 class="name card-title">1 Month</h3>
													  <h3 class="price">$9.97</h3>
													  <p class="pm">per month</p>
													  <hr>
													  <p class="desc">Billed $9.97 every month. 30-day money-back guarantee.</p>
													</div>
												</div>
											</span>
										</label>
								...
								<div class="col-sm-12 col-md-4 intel_box">
									<div class="check_box Plan">
										<input type="radio" id="prod32" value="32" name="productRadio">
										<label for="prod32">
											<span class="price">
												<div class="card card-important text-center">
													<div class="card-body shadow-sm">
													  <div class="pop text-center">MOST POPULAR</div>
													  <i class="fas fa-check-circle"></i>
													  <h3 class="name card-title" style="margin-top: -50px">12 Months</h3>
													  <h3 class="old_price">$<s style="font-size: 20px;">9.97</s></h3>
													  <h3 class="price pricing" style="color:red !important;">$6.99</h3>
													  <p class="pm">per month</p>
													  <hr>
													  <p class="desc">Billed <s style="color:#7F7F7F !important;">$119.64</s> $83.88 every 12 months. <br>30-day money-back guarantee.</p>
													  <p class="text-capitalize savings" style="color:red !important;">Save 30%</span></p>
													</div>
												</div>
											</span>
										</label>
								...
								<div class="col-sm-12 col-md-4 intel_box">
									<div class="check_box Plan">
										<input type="radio" id="prod31" value="31" name="productRadio">
										<label for="prod31">
											<span class="price">
												<div class="card text-center">
												  <div class="card-body shadow-sm">
													  <h3 class="name card-title">6 Months</h3>
													  <h3 class="price">$8.32</h3>
													  <p class="pm">per month</p>
													  <hr>
													  <p class="desc">Billed $49.95 every 6 months. <br>30-day money-back guarantee.</p>
													</div>
												</div>
											</span>
										</label>
				...
				if(checkIfProductaddedFromQuery != ''){
					...
					jQuery("input[value='"+checkIfProductaddedFromQuery.trim()+"']").parent().addClass("active");
...
function wgsRemoveProductFromCartAll(obj){
  ...
  jQuery.post("cart.php", 'ajax=1&' + jQuery("#form-remove-all-product").serialize(),
   function (data) {
	   ...
	   jQuery("#modalEmptyCartWgs").modal("hide");
   });	
}
...
/******* function for only update after X ms ********/
/**  <input type="text" onKeyUp="wgsDelayedFire(wgsCallAjaxForConfigureProduct, 1000 );" />  **/

function wgsDelayedFire(callbackFunction, ms) {
